...
def CSRNet(input_shape=(None, None, 3)):
    ...
    upsample = UpSampling2D(size=8, interpolation='bilinear')(x)
    output_flow = Conv2D(1, 1, strides=(1, 1), padding='same', activation='relu', kernel_initializer=dilated_conv_kernel_initializer)(upsample)
